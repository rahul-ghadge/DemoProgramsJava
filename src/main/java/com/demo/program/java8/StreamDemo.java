...
public class StreamDemo {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> list = Arrays.asList(new Integer[]{1, 2, 3, 4, 5, 6, 4, 8, 9, 7});
        ...
        System.out.println("-----------------");
        // Min from distict element
        Optional<Integer> minParallel = list.parallelStream().distinct().min(Comparator.naturalOrder());
        Optional<Integer> minParallel1 = list.stream().parallel().distinct().min(Comparator.naturalOrder());
        System.out.print("Min parallel : ");
        minParallel.ifPresent(System.out::println);
    }
}
